      ...
      <body>
        <main class="feed-shell">
          ...
          <section class="feed-card">
            ...
            <p>
              This page is an Atom feed. Paste its URL into a feed reader
              (Feedly, NetNewsWire, Inoreader, Miniflux, or any app that
              understands Atom) and new posts will appear there automatically.
            </p>
            <div class="feed-url-row">
              <code class="feed-url" id="feed-url"><xsl:value-of select="atom:link[@rel='self']/@href"/></code>
          ...
          <section class="feed-items">
            <h2>Recent items (<xsl:value-of select="count(atom:entry)"/>)</h2>
            <ul>
              <xsl:for-each select="atom:entry">
                <li class="feed-item">
                  <a class="feed-item__title" href="{atom:link[@rel='alternate']/@href}">
          ...
          <footer class="feed-foot">
            <p>
              <a href="{atom:link[@rel='alternate']/@href}">&#x2190; Back to <xsl:value-of select="atom:title"/></a>
            </p>
          </footer>
        </main>
