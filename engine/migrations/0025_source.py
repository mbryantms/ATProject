    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        db_index=True,
                        help_text='Unique key for citations, e.g., "smith2024climate". Auto-generated if left blank.',
                        max_length=120,
                        unique=True,
                        validators=[
                            django.core.validators.RegexValidator(
                                message="Citation key must start with a letter or digit, and contain only lowercase letters, digits, hyphens, and underscores.",
                ...
                (
                    "publisher_place",
                    models.CharField(
                        blank=True, help_text="City of publication.", max_length=200
                    ),
                ),
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        help_text='CSL date, e.g., {"date-parts": [[2024, 3, 15]]}. Supports partial dates (year-only, year-month).',
                        null=True,
                    ),
                ),
                (
                ...
                (
                    "issn",
                    models.CharField(blank=True, max_length=20, verbose_name="ISSN"),
                ),
                (
                    "pmid",
                    models.CharField(
                        blank=True, max_length=20, verbose_name="PubMed ID"
                    ),
                ),
                (
                    "url",
                    models.URLField(blank=True, max_length=2000, verbose_name="URL"),
                ),
                ...
                (
                    "note",
                    models.TextField(
                        blank=True, help_text="General notes about this source."
                    ),
                ),
                (
                    "csl_json",
                ...
                (
                    "zotero_raw",
                    models.JSONField(
                        blank=True, help_text="Raw Zotero JSON data.", null=True
                    ),
                ),
                (
                    "url_status",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["source_type", "is_deleted"],
                        name="engine_sour_source__a69f24_idx",
                    ),
                    models.Index(
                        fields=["url_status", "url_last_checked"],
                        name="engine_sour_url_sta_994c4e_idx",
                    ),
                ],
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(
                            ("citation_key__regex", "^[a-z0-9][a-z0-9_-]*$")
                        ),
